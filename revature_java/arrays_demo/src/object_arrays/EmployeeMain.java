...
public class EmployeeMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:System.out.println("Under construction");
				...
				break;
			case 4:System.out.println("Enter city name to get employees in that city");
				String city=scanner.next();
				Employee searchList[]=getEmployeesByCity(employeeList, city);
				if(searchList[0]==null) {
					System.out.println("No employees found from the city "+city);
				}else {
					System.out.println("Printing the employees from the city "+city);
			...
			case 5:System.out.println("Thanks for using our employee search app.....");
				...
				break;
			default:
				System.out.println("Invalid Chice.. Please Re-enter");
				break;
			}
		} while (ch != 5);
	...
	public static void printEmployees(Employee[] employeeList) {
		System.out.println("Printing details of " + employeeList.length + " employee/s");
		for (int i = 0; i < employeeList.length; i++) {

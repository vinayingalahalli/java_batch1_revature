...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * Player p1=new Player("Sachin", 22, "India"); Player p2=new Player("guru", 22,
		 * "India"); Player p3=new Player("Ajay", 24, "Australia"); Player p4=new
		 * Player("Jay", 29, "USA"); Player p5=new Player("Brian", 32, "USA"); Player
		 * p6=new Player("Mahesh", 22, "UK");
		 */
